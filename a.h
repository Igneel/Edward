...
1. Научить робота разворачиваться и подъезжать к старой координате, для возможности достижения целей вблизи стен.
    ...
    При таком подходе возникает проблема, находясь на середине - робот начинает метаться туда-сюда.
...
3. Найти способ получать команды с начала, а не с середины (если символ \n будет нормально передаваться - то все ок.)
    можно попробовать любой другой символ в качестве оконечивающего, в том числе например русские буквы - они не используются в командах.
4. Проверить результаты возвращаемые дальномерами.
    Возможно стоит вызывать эти функции не сразу, а с ожиданием.
    Частота вызовов этих функций уже была существенно уменьшена.
5. Думать над улучшением алгоритма корректировки движения.
    ...
    Интересно - с каким разрешением можно снимать показания с дальномера, если например не переводить в сантиметры...
6. Улучшать функцию эвристической оценки.
    +а) возможно ей стоит задать преимущественное направление, например вперед.
